-- ===========================================================================
-- RPC: match_archive
-- Liefert nächste Nachbarn im BGE-m3-Vektorraum über archive + projects.
-- Vektoren sind normalisiert → cosine similarity = 1 - (embedding <=> query).
-- ===========================================================================

CREATE OR REPLACE FUNCTION public.match_archive(
  query_embedding  vector(1024),
  match_count      integer DEFAULT 20,
  source_filter    text    DEFAULT NULL,     -- 'archive' | 'project' | NULL
  pub_type_filter  text[]  DEFAULT NULL,     -- z.B. ARRAY['OB02','award']
  canton_filter    text[]  DEFAULT NULL,     -- Filter auf Beschaffungsstandort
...
BEGIN
  ...
  WITH joined AS (
    ...
    FROM public.archive_embeddings e
...
-- Grant execute (RLS der Basistabellen greift weiterhin beim JOIN)
