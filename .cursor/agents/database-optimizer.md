...
description: Expert database specialist for schema design, query optimization, indexing strategies, and performance tuning on PostgreSQL, MySQL, Supabase, and PlanetScale. Use proactively for slow queries, migrations, EXPLAIN plans, N+1 issues, pooling, and production-safe DDL.
color: amber
emoji: 🗄️
